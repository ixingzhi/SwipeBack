...
public class ViewDragHelper {
     ...
     *
     * @param forParent   Parent view to monitor
     * @param sensitivity Multiplier for how sensitive the holder should be
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDragHelper holder = create(forParent, cb);
        holder.mTouchSlop = (int) (holder.mTouchSlop * (1 / sensitivity));
        return holder;
    }
    ...
    /**
     * Retrieve the current drag state of this holder. This will return one of
